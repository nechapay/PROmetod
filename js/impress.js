...
;(function (document, window) {
  ...
  document.addEventListener('impress:init', function (e) {
    ...
    triggerEvent(document, 'impress:help:add', { command: 'H', text: 'Показать это окно', row: 0 })
  })
})(document, window)
...
;(function (document, window) {
    ...
    var open = function () {
      ...
      if (consoleWindow && !consoleWindow.closed) {
        ...
        if (consoleWindow == null) {
          ...
          message.innerHTML =
            '<button style="' + styleStr + '" ' + 'onclick="' + clickStr + '">' + lang.clickToOpen + '</button>'
  ...
  document.addEventListener('impress:init', function (event) {
    ...
    triggerEvent(document, 'impress:help:add', { command: 'P', text: 'Режим докладчика', row: 10 })
  })
